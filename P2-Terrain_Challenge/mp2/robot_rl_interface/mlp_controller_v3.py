"""
Mini Pupper 2 RL Controller - v3
=================================
Major fixes in v3:
1. EMA smoothing instead of accumulating smoothing
2. Proper rate limiting after smoothing
3. Conservative default parameters (ACTION_SCALE=0.25)
4. Enhanced observation monitoring
5. Simulation action replay for validation
6. Better debug output with raw vs final actions

Changes from v2:
- Fixed smoothing formula to use proper EMA (ema_alpha parameter)
- Fixed rate limiting logic (now uses final_actions)
- Added observation health checks
- Added simulation action replay test
- Lowered default ACTION_SCALE to 0.25
