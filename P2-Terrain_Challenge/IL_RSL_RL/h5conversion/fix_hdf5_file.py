...
def fix_hdf5_for_robomimic(input_path, output_path=None):
    ...
    with h5py.File(input_path, 'r') as f_in:
        with h5py.File(temp_path, 'w') as f_out:
            ...
            # Add required env_args metadata
            env_args = {
    ...
    with h5py.File(output_path, 'r') as f:
        ...
        print(f"env_args: {f['data'].attrs['env_args']}")
...
if __name__ == "__main__":
    ...
    output_file = "/workspace/rosbag_recordings/hdf5_datasets/mini_pupper_demos_robomimic.hdf5"
