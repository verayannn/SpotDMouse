...
** Update : ** We have upgraded to the Mini Pupper 2 which has servo feebdack and an IMU sensor, enabling the robot with proprioception and oritenation w.r.t. gravity! New training and demo results incoming.
