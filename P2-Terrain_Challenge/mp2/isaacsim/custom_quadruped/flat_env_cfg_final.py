...
class SpotRewardsCfg:
    ...
    base_linear_velocity = RewardTermCfg(
        ...
        params={"std": 0.5, "ramp_rate": 0.5, "ramp_at_vel": 0.4, "asset_cfg": SceneEntityCfg("robot")},#OG Spot params={"std": 1.0, "ramp_rate": 0.5, "ramp_at_vel": 1.0, "asset_cfg": SceneEntityCfg("robot")}
    )
    ...
    foot_clearance = RewardTermCfg(
        ...
        params={
            "std": 0.03, #0.05
            "tanh_mult": 2.0,
            "target_height": 0.03,#0.1 #Trying 0.5, 0.4, and 0.03 to overcome latency resistance and gravity in reality.
    ...
    joint_torques = RewardTermCfg(
        ...
        weight=-5.0e-3, #*************** OG/Best: -5.0e-4 FUNCTIONAL: -1.0e-4 
